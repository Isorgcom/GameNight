<?php
/**
 * Tournament Timer layout CRUD. Deliberately its own endpoint so timer_dl.php
 * is untouched by the layout work; deleting the layout files plus this one
...
// Named-font whitelist — the KEYS of FONTS in timer_display.js, kept in lock-step.
 ...
 * the same acceptance rule as `normalizeStreamUrl()` in timer_display.js, which
