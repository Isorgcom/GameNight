...
// get_occurrence_invitees() and get_next_occurrence() moved to db.php (v0.1970)
// so calendar.php's delete_occurrence handler can use them too — it previously
// called get_occurrence_invitees() without any include defining it (fatal).
