...
/* PCF: the first ARTWORK built-in — glossy plates painted into two background
 * images shipped as repo files (www/img/timer_beta/), which is why
 * safeImageSrc() and the server's pk_lo_img() both allow that one static
 * prefix alongside uploads. Generated by the art-board builder in the session
 * scratchpad (geometry constants -> CSS art + this tree), not hand-tuned:
 * regenerate there rather than nudging weights here. Carries an aspect lock
 * (the art is 1280x800) and a desktop-only QR cell. */
LAYOUTS.pcf = {"v": 1,"aspect": 1.6,"screens": [{"name": "Break","when": "on_break","bg": {"image": "/img/timer_beta/pcf-break.jpg"},"root": {"col": [{"row": [{"col": [{"cell": {"text": "\u00b7","size": 2,"opacity": 0},"weight": 1.5},{"cell": {"text": "","size": 2,"qr": "display","pad": "0.6vh 0"},"weight": 1.28},{"cell": {"text": "\u00b7","size": 2,"opacity": 0},"weight": 0.12}],"weight": 3.5},{"cell": {"text": "<clock>","size": 15.5,"color": "#ffffff","bold": true},"weight": 6.8},{"col": [{"cell": {"text": "\u00b7","size": 2,"opacity": 0},"weight": 1.3},{"cell": {"text": "<gameName>","size": 2,"color": "#ffffff","bold": true},"weight": 1.1},{"cell": {"text": "\u00b7","size": 2,"opacity": 0},"weight": 0.5}],"weight": 2.5}],"weight": 36.3},{"row": [{"col": [{"cell": {"text": "Round: <level>","size": 3.1,"color": "#ffffff","bold": true,"pad": "0 1.4vw"},"weight": 1},{"cell": {"text": "<playersLeft> of <playersTotal> Players","size": 3.1,"color": "#ffffff","bold": true,"pad": "0 1.4vw"},"weight": 1},{"cell": {"text": "Total Chips: <chipCount>","size": 3.1,"color": "#ffffff","bold": true,"pad": "0 1.4vw"},"weight": 1},{"cell": {"text": "Avg Stack: <avgStack>  (<avgStackBB>)","size": 3.1,"color": "#ffffff","bold": true,"pad": "0 1.4vw"},"weight": 1},{"cell": {"text": "Next Break in: <nextBreak>","size": 3.1,"color": "#ffffff","bold": true,"pad": "0 1.4vw"},"weight": 1}],"weight": 4.7,"pad": "1.5vh 0 13.5vh"},{"col": [{"cell": {"text": "BREAK","size": 9,"color": "#ffffff","bold": true},"weight": 2},{"cell": {"text": "Next up: <nextBlinds>","size": 3.4,"color": "#ffffff","bold": true},"weight": 1}],"weight": 5.3,"pad": "0 0 13.5vh"}],"weight": 63.8}]}},{"name": "Main","bg": {"image": "/img/timer_beta/pcf-main.jpg"},"root": {"col": [{"row": [{"col": [{"cell": {"text": "\u00b7","size": 2,"opacity": 0},"weight": 1.5},{"cell": {"text": "","size": 2,"qr": "display","pad": "0.6vh 0"},"weight": 1.28},{"cell": {"text": "\u00b7","size": 2,"opacity": 0},"weight": 0.12}],"weight": 3.5},{"cell": {"text": "<clock>","size": 15.5,"color": "#ffffff","bold": true},"weight": 6.8},{"col": [{"cell": {"text": "\u00b7","size": 2,"opacity": 0},"weight": 1.3},{"cell": {"text": "<gameName>","size": 2,"color": "#ffffff","bold": true},"weight": 1.1},{"cell": {"text": "\u00b7","size": 2,"opacity": 0},"weight": 0.5}],"weight": 2.5}],"weight": 36.3},{"row": [{"col": [{"cell": {"text": "Round: <level>","size": 3.1,"color": "#ffffff","bold": true,"pad": "0 1.4vw"},"weight": 1},{"cell": {"text": "<playersLeft> of <playersTotal> Players","size": 3.1,"color": "#ffffff","bold": true,"pad": "0 1.4vw"},"weight": 1},{"cell": {"text": "Total Chips: <chipCount>","size": 3.1,"color": "#ffffff","bold": true,"pad": "0 1.4vw"},"weight": 1},{"cell": {"text": "Avg Stack: <avgStack>  (<avgStackBB>)","size": 3.1,"color": "#ffffff","bold": true,"pad": "0 1.4vw"},"weight": 1},{"cell": {"text": "Next Break in: <nextBreak>","size": 3.1,"color": "#ffffff","bold": true,"pad": "0 1.4vw"},"weight": 1}],"weight": 4.7,"pad": "1.5vh 0"},{"col": [{"cell": {"text": "<blinds>","size": 7.5,"color": "#ffffff","bold": true},"weight": 2},{"cell": {"text": "<nextBlinds>","size": 4,"color": "#ffffff","bold": true},"weight": 1.5,"pad": "0 0 1vh"}],"weight": 5.3}],"weight": 52.8},{"row": [{"cell": {"text": "\u00b7","size": 2,"opacity": 0},"weight": 2.4},{"cell": {"text": "","size": 2.4,"color": "#ffffff","bold": true,"chips": true,"chipSize": 4.6},"weight": 6},{"cell": {"text": "\u00b7","size": 2,"opacity": 0},"weight": 1.6}],"weight": 11}]}}],"name": "PCF Poker Chip Forum"};
...
/* Tournament Director's spellings for the same things, so a layout written by
 * someone who knows TD works here without a translation step. Aliases resolve
 * to our own elements rather than duplicating them, and are deliberately kept
 * OUT of the editor's picker: one canonical name to choose from, many accepted.
 *
 * Lookup is case-insensitive for both, because TD writes <SmallBlind> while we
 * write <smallBlind>, and a name that renders as ⟨smallblind⟩ over nothing but
 * capitalisation is a bad afternoon. */
var ELEMENT_ALIASES = {
    round: 'level', rounds: 'roundsTotal', timer: 'clock', elapsed: 'elapsedTime',
    averagestack: 'avgStack', unadjustedchipcount: 'chipCount',
    totalpot: 'pot', prizemoneyleft: 'pot',
    buyinchips: 'startChips', rebuychips: 'startChips', addonchips: 'addOnChips',
    buyinfee: 'buyInFee', rebuyfee: 'rebuyFee', addonfee: 'addOnFee',
    roundbeforenextbreak: 'roundsToBreak', breaktext: 'levelOrBreak',
    title: 'eventName', starttime: 'startTime'
};
...
function rebuildElementIndex() {
    ...
    Object.keys(ELEMENT_ALIASES).forEach(function (a) {
        var target = ELEMENT_ALIASES[a];
...
var COND_VALUES = {
    ...
    // cannot change.
    mobile:       function () { return isCoarse() && minSide() < 600; },
    tablet:       function () { return isCoarse() && minSide() >= 600; },
    desktop:      function () { return !isCoarse(); },
    pc:           function () { return !isCoarse(); },   // spoken alias
...
var COND_NAMES = ['round', 'smallBlind', 'bigBlind', 'ante', 'playersLeft', 'playersTotal',
