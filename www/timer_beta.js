...
var COND_NAMES = ['round', 'smallBlind', 'bigBlind', 'ante', 'playersLeft', 'playersTotal',
    ...
    'prizePool', 'tables', 'seats', 'minutesLeft', 'secondsLeft', 'levelChange',
 ...
 * author MEANT: case-insensitive and through the TD aliases, same as element
...
function buildScreen(idx) {
    ...
    fitCells = []; clockCells = []; allCells = []; qrCells = []; chipCells = []; seatCells = [];
    root.textContent = '';
