...
<div class="help-step" id="two-timers">
    ...
    <div class="help-step" id="building">
        ...
        <p><strong>Fonts:</strong> every text cell has a <strong>Font</strong> setting in the Inspector and the right-click menu, with a set of named looks &mdash; Serif, Monospace, Condensed, Wide, Heavy, Impact, Script, Comic &mdash; each previewed in the dropdown itself. They are built from faces a TV, tablet or phone already has, so a layout renders without downloading anything and a device missing one face falls back to the same shape of letter. A <strong>shared style</strong> can carry a font too, so one setting gives a whole design its typeface.</p>
