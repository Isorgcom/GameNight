...
function renderDashboard() {
    ...
    if (isTourney()) {
        ...
        h += '<a class="pk-btn-settings" href="/gameday.php?event_id=' + <?= (int)$event['id'] ?> + '" style="text-decoration:none" title="Game Day: phone-first table console">&#127918;<span class="pk-act-label"> Game Day</span></a>';
    }
